...
import { RequestEnum, ResultEnum, ContentTypeEnum } from '@monorepo/enums/lib/httpEnum'
import { PageEnum } from '@monorepo/enums/lib/pageEnum'
...
const transform: AxiosTransform = {
  ...
  requestInterceptors: (config, options) => {
    // 请求之前处理config
    const token = storage.get((config as Recordable)?.tokenKey)
